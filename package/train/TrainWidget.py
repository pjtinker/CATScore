...
class TrainWidget(QTabWidget):
    def __init__(self, parent=None):
        ...
        self.model_widget.comms.update_statusbar.connect(self.update_statusbar)
        self.addTab(self.data_loader, 'Data Loader')      
        self.addTab(self.model_widget, 'Model Trainer')
